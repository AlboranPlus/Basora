...
export function LoginPage() {
  ...
  const inputStyle = { width: '100%', padding: '10px 14px', border: '1.5px solid #dcccac', borderRadius: 10, fontSize: 14, color: '#2c2a1e', background: '#fff8ec', outline: 'none', boxSizing: 'border-box' as const, marginBottom: 12 }
